...
namespace cmoon::tests::concepts
{
	...
	cmoon::test::test_suite get_tests()
	{
		...
		suite.add_test_case<object_test>();
		suite.add_test_case<array_test>();
		suite.add_test_case<supplier_test>();
		suite.add_test_case<unary_operator_test>();
		suite.add_test_case<consumer_test>();
		suite.add_test_case<function_object_test>();
		suite.add_test_case<arithmetic_test>();
		suite.add_test_case<signed_arithmetic_test>();
		suite.add_test_case<unsigned_arithmetic_test>();
		suite.add_test_case<complete_type_test>();
		suite.add_test_case<had_size_test>();
